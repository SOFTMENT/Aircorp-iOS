...
admin.initializeApp({
  credential: admin.credential.cert({
   type: "service_account",
    ...
    client_email: "firebase-adminsdk-g9pmp@aircorp-f42be.iam.gserviceaccount.com",
    client_id: "112007333328477313566",
    auth_uri: "https://accounts.google.com/o/oauth2/auth",
    token_uri: "https://oauth2.googleapis.com/token",
    auth_provider_x509_cert_url: "https://www.googleapis.com/oauth2/v1/certs",
    client_x509_cert_url: "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-g9pmp%40aircorp-f42be.iam.gserviceaccount.com",
    universe_domain: "googleapis.com"
  }),
});
      /* eslint-enable max-len */

admin.auth().setCustomUserClaims("GQX45tl32VNtEdEUnoSoSXuq9js2",
  {admin: true})
.then(() => {
